    ...
    <div className="cart-page">
      <div className="container">
        <div className="breadcrumb">
          <ul className="breadcrumb-items d-flex2">
                  ...
                  {cartProducts.map((cartProducts) => (
                    <div className="cart-item grid" key={cartProducts.id}>
                      <div className="cart-item-img flex  flex-column bg-white">
                        <img src={cartProducts.images[0]} />
                        <button
                          type="button"
                          className="btn-square rmv-from-cart-btn"
                          onClick={()=>dispatch(removeFromCart(cartProducts.id))}
                        >
                      ...
                      <div className="cart-item-info">
                        ...
                        <div className="qty flex">
                          ...
                          <div className="qty-change flex">
                            ...
                            onClick={()=>dispatch(toggleCartQty({id:cartProducts.id,type:"DEC"}))}
                            >
                              <i className="bi bi-dash text-light-blue"></i>
                            </button>
                            ...
                            <button
                              ...
                              onClick={()=>dispatch(toggleCartQty({id:cartProducts.id,type:"INC"}))}
                            >
                        ...
                        <div className="flex flex-between">
                          <div className="text-pine-green fw-4 fs-15 price">
                            Price:{formatPrice(cartProducts.price)}
                          </div>
                          <div className="sub-total fw-6 fs-18 text-regal-blue">
                            <span>Sub Total:</span>
                            <span className="">
                              {formatPrice(cartProducts.totalPrice)}
                            </span>
                          </div>
                        </div>
                      </div>
